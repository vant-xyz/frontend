        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="text-left">
                <div className="text-red-600 text-3xl font-bold mb-2">1min</div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="text-left">
                <div className="text-red-600 text-3xl font-bold mb-2">Instant</div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="text-left">
                <div className="text-red-600 text-3xl font-bold mb-2">Zero</div>
